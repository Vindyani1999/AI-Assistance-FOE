...
class Memory:
    ...
    Methods:
        write_chat_history_to_file(chat_history: List, thread_id: str, folder_path: str) -> None:
    ...
    """
    @staticmethod
    def write_chat_history_to_file(chat_history: List,  thread_id: str, folder_path: str) -> None:
        """
        ...
        Args:
            chat_history (List): A list containing tuples of user queries and chatbot responses. 
        ...
        """
        tmp_list = list(chat_history[-1])  # Convert the tuple to a list
